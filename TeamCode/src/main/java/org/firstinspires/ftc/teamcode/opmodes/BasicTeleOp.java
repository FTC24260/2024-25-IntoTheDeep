...
public class BasicTeleOp extends LinearOpMode {
    ...
    private enum IntakeState {
        POSITIONING, INTAKE, TRANSFER, SPECIMEN, FULLYBACK, SPECIMENUP
    }
    ...
    public void goToRaisedIntake() {
        ...
        intakeState = IntakeState.SPECIMENUP;
    }
    ...
    public void ShoulderHighTransfer() {
        OuttakeShoulder.setPosition(ShoulderPositionHighTransfer);
        outtakeShoulderState = OuttakeShoulderState.TRANSFER;
    }
    ...
    public void toggleIntakeWristC() {
        ...
        } else if (intakeWristState == IntakeWristState.UPSIDEDOWN){
            intakeWrist135CC();
            sleep(300);
        }
    }
...
//                }
        ...
        public void HandleNonChassisMovements () {
            ...
            if (gamepad2.start) {
                if (intakeState == IntakeState.INTAKE || intakeState == IntakeState.SPECIMEN || intakeState == IntakeState.POSITIONING) {
                    toggleIntakeClaw();
                } else {
                    toggleOuttakeClaw();
                }
            ...
            if (gamepad2.x) {
                ...
                leftFront.setPower(0);
                leftRear.setPower(0);
                if (intakeState == IntakeState.INTAKE || intakeState == IntakeState.SPECIMENUP){
                    goToPositioningFromIntake();
